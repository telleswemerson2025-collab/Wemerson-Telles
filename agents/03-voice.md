...
1. Escrever o **corpo do post** (≤ 280 caracteres), afirmação primeiro, com a leitura do dado, nunca dado cru
   (invariante 4). **Link permitido no corpo** (invariante 3, decisão do Gui 25/07/2026) ou no reply, à escolha.
2. Escrever o **primeiro reply** com contexto/fonte. O **link** pode ficar aqui ou no corpo do post (invariante 3).
...
- Uma ideia só (invariante 1). Link no corpo do post OU no reply, à escolha (invariante 3).
