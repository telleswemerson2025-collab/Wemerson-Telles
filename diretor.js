...
function renderJogos(cor){
  ...
  <div class="card"><div style="display:flex;justify-content:space-between;margin-bottom:5px"><span style="font-size:10px;color:var(--text-3);font-weight:500">${j.cat} · ${(typeof fmtDataConv==='function')?fmtDataConv(j.data):j.data}${(j.hora&&j.hora!=='00:00')?' · '+j.hora:''}</span><span class="tag tb">agendado</span></div>
