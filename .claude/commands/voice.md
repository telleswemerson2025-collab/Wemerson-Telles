...
2. Escreva o corpo do post (≤280) e o primeiro reply. O link pode ir no corpo do post OU no reply, à escolha (invariante 3). Voz humanizada e acessível, sem travessão (em dash), uma ideia só.
