...
- **Ação:** (1) Diagnóstico intacto: **distribuição é o gargalo**; o empurrão fora do X (WhatsApp) foi o que destravou reach e engajamento, prova de conceito da frente Tier A. Repetir a distribuição fora do X nos próximos posts e medir. (2) A hipótese "posts de regime/coorte retêm quem chega" acumula agora seu sinal mais forte (9 expands), mas segue em n minúsculo, observar, não concluir. (3) Coletar ainda o final do post de teste @VantageNodvt (2081089146026647741) para fechar o experimento das duas contas.
