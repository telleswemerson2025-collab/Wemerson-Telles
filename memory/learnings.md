...
- **Leitura:** melhor post da série em todos os campos. 51 impressões = maior alcance já medido (série de teste ia de 15 a 36) e é o **1º bookmark desde o MVRV de 16/07** (quebra a sequência de 0). Sinais de **lean-in** os mais fortes já vistos: 9 detail expands (17,6% de quem alcançou abriu pra ler) e 4 link clicks (primeiros cliques de link relevantes, este post tinha link no corpo) confirmam de novo a hipótese "quem chega, engaja com densidade". Bookmark rate 2,0% (1/51); `analyst_saved` indeterminado (n=1). Ressalva dura: conta nova + **empurrão de WhatsApp** + n minúsculo (51); o engagement rate de 64,7% é real mas sobre base minúscula, não extrapolar. O que moveu o ponteiro foi **distribuição** (WhatsApp), não a copy.
- **Correção de dado:** o "18,5K impressões / 2,9%" que eu havia posto em quarentena era **card promocional NÃO relacionado** (datas futuras ago 1-6, comparativo de período). **Descartado.** Reforça a regra: não registrar número cujo escopo não bate com o post, e conferir sempre a tela de origem.
- **Experimento das duas contas FECHADO (mesmo conteúdo, 25/07):** OFICIAL @VantageNodeio 51 imp · 33 eng · 64,7% · 9 expands · 4 link clicks · **1 bookmark** (com empurrão de WhatsApp) vs TESTE @VantageNodvt 20 imp · 3 eng · 15% · 1 expand · 0 link clicks · **0 bookmark** (sem WhatsApp). Texto idêntico, a oficial teve **2,5x o alcance e 11x os engajamentos**. A única diferença de tratamento foi a **distribuição fora do X (WhatsApp)** na oficial. É a evidência mais limpa até hoje de que o gargalo é **distribuição, não conteúdo**. Ressalva: n de 51 e 20, direção inequívoca, magnitude não conclusiva.
- **Ação:** (1) Diagnóstico confirmado com controle: **distribuição é o gargalo**; o empurrão fora do X destravou reach e engajamento, prova de conceito da frente Tier A. Repetir a distribuição fora do X em todo post novo e medir. (2) A hipótese "posts de regime/coorte retêm quem chega" acumula seu sinal mais forte (9 expands na oficial), mas segue em n minúsculo, observar, não concluir. (3) Prioridade estratégica que os dados sustentam: **Tier A (interação/replies em contas de alcance) + X Premium** como alavancas de distribuição (proposta do Gui), acima de produzir mais posts no vácuo.
