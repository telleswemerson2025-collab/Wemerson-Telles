...
que substituiu o "Trader de Sucesso") é anual como os demais, **mas quem é Vitalício tem direito
a acessá-lo por 2 anos**. Ou seja: 12 meses é o padrão; os "2 anos" são o benefício do Vitalício
especificamente sobre o treinamento em análise. A liberação acontece **em até 7 dias** após a compra.
...
> (Os endereços acima são de recebimento público — podem ser passados ao cliente.)

### Prazo de liberação do acesso
Na Hotmart (cartão, boleto ou Pix), a liberação segue a confirmação do pagamento. Em cripto
(USDT ou BTC), a liberação é manual: envie o comprovante/TXID pro suporte e liberamos o
...
atualizada; análises em vídeo semanais dos aportes; comunidade dentro do app com suporte; e,
como bônus, a **Academy BlockCapital (75 aulas)** — fundamentos e segurança, mentalidade,
análise gráfica e on-chain. A proposta é replicar por cópia (~10 min/semana): você não decide,
só replica. Do FAQ: **o dinheiro fica 100% na sua corretora, no seu nome** (a equipe não tem
acesso ao capital); e nada ali é recomendação de compra/venda — é conteúdo educacional e
carteira-modelo, com as decisões e riscos sempre do cliente.

### Duas carteiras / dois domínios (estrutura)
São produtos diferentes: a **Rumo ao Milhão (CRM)** é de **cripto** (BTC/USDT, defensivo em
...
aparece apenas como produto **bloqueado/cadeado** ("Você ainda não tem esta carteira") — é
vitrine/upsell, não acesso incluído. A **CRM (Rumo ao Milhão) fica em outro ambiente:
guitelles.academy** (área "BlockCapital by Gui Telles"), onde o conteúdo dela é entregue como
curso próprio. Resumo pro cliente: **cada carteira tem seu próprio ambiente e login** — CRM em
guitelles.academy/app; Carteira IA em theblockcapital.com. Quem quer as duas num acesso só migra
pra **Carteira Vitalícia** (condições tratadas pelo time; ver desconto de migração acima).

### Quem é o Gui Telles
No mercado de criptoativos desde 2017, analista on-chain, fundador da BlockCapital e da
VantageNode.

> ⚠️ Nota interna: a página de vendas exibe números de desempenho fortes (ex.: "+195% desde
> 2023", "R$16 mi em lucros"). São claims de marketing da página — ao responder cliente,
> **não repita como garantia** nem como promessa de retorno. Mantenha o "não é recomendação /
> desempenho passado não garante futuro". Se o cliente perguntar, aponte a página oficial.

### Cancelar renovação — detalhe do app mobile (mineração 08/08/2026)
CONFIRMADO: a opção de cancelar a renovação na Hotmart às vezes **não aparece no app do celular**,
só pelo **computador/navegador**. Se o cliente disser que não acha a opção no celular, oriente a
tentar pelo computador (Assinaturas → Configurar Pagamento → Cancelar assinatura). Não achando a
assinatura, contatar o SAC da Hotmart com o **código de compra** em mãos.

### Assinatura paga via Pix — como funciona a renovação (mineração 08/08/2026)
CONFIRMADO: quem pagou via **Pix** mantém o Pix como método nas renovações. Se o cliente **não
pagar o Pix** da renovação, a assinatura é **cancelada automaticamente por falta de pagamento** —
não precisa de ação manual de cancelamento. (Diferente do cartão, que renova sozinho enquanto o
cartão for válido.)

### "Não consigo usar a carteira" — app bônus × conteúdo real (mineração 08/08/2026)
CONFIRMADO: há um **app bônus de gerenciamento financeiro pessoal** (registro de gastos) que NÃO
é a Carteira. Cliente recém-chegado às vezes confunde os dois. A **Carteira** de verdade é
acompanhada pelos **vídeos publicados às segundas** e pela **Comunidade dentro do app/plataforma
principal** (e, na Carteira IA, pelo portal theblockcapital.com em Publicações/Decisões). Ao
responder, deixar clara essa distinção.

### Cliente quer TROCAR a forma de pagamento (à vista → parcelado) — procedimento
CONFIRMADO (caso real, 08/08/2026): quando o cliente já comprou **à vista** e quer mudar para
**parcelado (ex.: 12x)**, o procedimento é: o cliente **faz uma nova compra na forma desejada** e,
